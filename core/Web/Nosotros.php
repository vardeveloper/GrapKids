...
class Web_Nosotros extends Web_BasePage 
{

    public function mainContent() 
    {
        parent::set_title('Nosotros | Juegos Recreativos Infantiles | Grap Kids');
        ...
        return $smarty->fetch(APP_ROOT . DS . 'tpl' . DS . 'nosotros.tpl');
    }
