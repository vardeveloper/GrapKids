...
<page backcolor="#FEFEFE" backimg="./res/bas_page.png" backimgx="center" backimgy="bottom" backimgw="100%" backtop="0" backbottom="30mm" footer="page" style="font-size:1em">
    ...
    <table style="width:100%;text-align:center;border:solid 1px black" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td class="celda" style="width:40%;text-align:left;padding:0 10px"> <strong>{$producto.nombre}</strong> <br /> {$producto.detalle} </td>
...
{foreach from=$productos item=producto}
<page footer="page">
    <h1 align="center" style="font-weight: bold; font-size: 20pt; line-height: 30pt; color: #000; text-align: center; width: 80%">{$producto.nombre}</h1>
    {foreach from=$producto.imagenes key=k item=image}
        <br /><br />
        <table align="center">
        <tr>
            <td>
