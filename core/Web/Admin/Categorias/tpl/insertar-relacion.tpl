...
{/literal}
<h2 class="span contenttitle w-98">Administrador de SubCategorías</h2>
<div class="span adm_datahead w-98">
    ...
    <a class="adm_btn span adm_btn2" href="{$smarty.const.WEB_ROOT}/admin/categorias/productos">Productos</a>
</div>
<p class="titulo">Crear Nueva SubCategoría </p>
